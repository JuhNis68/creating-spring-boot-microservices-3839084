...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        TourManagementService tourManagement = context.getBean(TourManagementService.class);
        tourManagement.createTour("Tour de France", 1500, false);

        System.out.println("\n******Explore California Tour Catalogue AGAIN ******");
        agent.displayTours();
    }
}